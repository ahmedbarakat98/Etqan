    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative top-4 right-4 flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto ${
          ...
          >
            ...
            >
              ...
              >
                {textLines.map((l, i) => (
                  <span
                    className="sm-toggle-line block h-[1em] text-sky-400 leading-none"
                    key={i}
                  >
                    {l}
                  </span>
            ...
            <span
              ref={iconRef}
              className="sm-icon relative text-sky-400 w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform]"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
