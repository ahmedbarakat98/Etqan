      ...
      <div className="flex bg-[#0C1D33] flex-col md:flex-row p-5">
        ...
        <div className="w-full md:w-1/3 h-auto p-8 flex flex-col items-center text-center  justify-center ">
          ...
          <p className=" text-[#6CC2EE] text-[13px] ">To deliver high-quality 
            spatial systems and geospatial services that enhance decision-making
             for governments, NGOs, and private-sector partners through advanced 
             technologies and strategic global collaborations</p>
